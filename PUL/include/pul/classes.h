...
#define PUM_TABLE_REMRECORD			PU_TABLECLASS_MTD + 13	// Param: record
#define PUM_TABLE_SETFIELDVAL		PU_TABLECLASS_MTD + 14	// Param1: value
#define PUM_TABLE_CLEAR				PU_TABLECLASS_MTD + 15
